...
```{r}
pool1 <- Read10X('PRJEB40376/Pool_1/raw_feature_bc_matrix/')
pool2 <- Read10X('PRJEB40376/Pool_2/raw_feature_bc_matrix/')
pool3 <- Read10X('PRJEB40376/Pool_3/raw_feature_bc_matrix/')
pool4 <- Read10X('PRJEB40376/Pool_4/raw_feature_bc_matrix/')
pool5 <- Read10X('PRJEB40376/Pool_5/raw_feature_bc_matrix/')
pool6 <- Read10X('PRJEB40376/Pool_6/raw_feature_bc_matrix/')
pool7 <- Read10X('PRJEB40376/Pool_7/raw_feature_bc_matrix/')
pool8 <- Read10X('PRJEB40376/Pool_8/raw_feature_bc_matrix/')
pool9 <- Read10X('PRJEB40376/Pool_9/raw_feature_bc_matrix/')
pool10 <- Read10X('PRJEB40376/Pool_10/raw_feature_bc_matrix/')
